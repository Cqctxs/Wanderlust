    ...
    <div>
      ...
      <Box>
        <Dialog open={open} onClose={handleToClose} fullScreen={true}>
          <DialogContent className="bg-[#252322]">
            <div className="h-full w-full bg-[#252322] flex flex-col justify-center overflow-hidden items-center px-8 pb-20 pt-12">
              <h1 className="text-wh font-sans text-8xl mb-12">
                Your trip to {travData?.country}
              </h1>
                ...
                <div className="flex flex-col w-2/5 space-y-4">
                  <div className="relative bg-[#353130] rounded-2xl shadow-lg p-8 pb-8 flex flex-col overflow-y-auto h-[500px]">
                    <div className="text-wh text-lg flex-1">
                      <h1 className="text-wh font-sans text-4xl mb-2 text-center">
                        Travel Itinerary
                      </h1>
              ...
              <div className=" justify-end items-center">
                <a
                  className="bg-blu absolute right-12 bottom-8 text-wh flex font-sans text-1xl font-bold py-4 px-7 mt-8 rounded-full shadow-md transition-transform hover:scale-105"
                  onClick={() => {
                    handleToClose();
                  }}
                >
